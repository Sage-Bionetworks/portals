...
export const dataSql = 'SELECT * FROM syn11346063.16'
export const dataOnStudiesPageSql = "SELECT id, metadataType, dataType, assay FROM syn11346063.16 WHERE `resourceType` = 'metadata'"
