...
export const dataSql = 'SELECT * FROM syn11346063.17'
export const dataOnStudiesPageSql = "SELECT id, metadataType, dataType, assay FROM syn11346063.17 WHERE `resourceType` = 'metadata'"
