...
export const dataSql = 'SELECT * FROM syn11346063.13'
export const dataOnStudiesPageSql = "SELECT id, metadataType, dataType, assay FROM syn11346063.13 WHERE `resourceType` = 'metadata'"
