...
export const dataOnStudiesPageSql =
  "SELECT id, metadataType, dataType, assay FROM syn11346063.17 WHERE `resourceType` = 'metadata'"
...
export const targetEnablingResourcesDetailsPageSql = 'select * from syn26146692'
