...
export const dataSql = 'SELECT * FROM syn11346063.15'
export const dataOnStudiesPageSql = "SELECT id, metadataType, dataType, assay FROM syn11346063.15 WHERE `resourceType` = 'metadata'"
