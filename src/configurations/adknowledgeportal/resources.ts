...
export const dataSql = 'SELECT * FROM syn11346063.14'
export const dataOnStudiesPageSql = "SELECT id, metadataType, dataType, assay FROM syn11346063.14 WHERE `resourceType` = 'metadata'"
