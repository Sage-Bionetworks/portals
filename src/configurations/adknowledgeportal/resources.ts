...
export const dataSql = 'SELECT * FROM syn11346063.12'
export const dataOnStudiesPageSql = "SELECT id, metadataType, dataType, assay FROM syn11346063.12 WHERE `resourceType` = 'metadata'"
