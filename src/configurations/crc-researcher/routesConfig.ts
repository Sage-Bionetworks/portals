...
const routes: GenericRoute[] = [
  {
    ...
    synapseConfigArray: [
      ...
      },
      {
        ...
        props: {
          widgetparamsMapped:{
              query:'SELECT "date", CONTACT as "New accounts created", survey_1 as "Survey 1", survey_2 as "Survey 2", survey_3 as "Survey 3", survey_4 as "Survey 4" FROM syn22314856',
