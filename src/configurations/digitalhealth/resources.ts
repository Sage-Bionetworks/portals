...
export const projectsSql =
  "SELECT * FROM syn21994974.5 WHERE  dhPortalIndex = 'TRUE' and isDHProject = 'TRUE' ORDER BY 'study'"
export const studySql =
  "SELECT * FROM syn21994974.5 WHERE ((isDHProject IS NULL) OR (isDHProject <> 'TRUE')) AND (dhPortalIndex = 'TRUE') ORDER BY 'study'"
