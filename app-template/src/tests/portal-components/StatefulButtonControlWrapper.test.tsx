...
import StatefulButtonControlWrapper, { StatefulButtonControlWrapperProps } from '../../portal-components/StatefulButtonControlWrapper'
...
describe('StatefulButtonControlWrapper works', () => {
  ...
  it('renders correctly', async () => {
    const component = await mount(<MemoryRouter><StatefulButtonControlWrapper {...props} /></MemoryRouter>)
    // check its defined
